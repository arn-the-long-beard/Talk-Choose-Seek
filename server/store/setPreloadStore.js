...
export const preparePreload = (state) => {
  if (state.talkAndChooseAndSeek) {
    ...
    let talkAndChooseAndSeek = {seek: { didInvalidate: true, maxResults: state.talkAndChooseAndSeek.seek.maxResults, content: null, asked: state.talkAndChooseAndSeek.seek.asked, items: [], errors: null, isRequesting: false, preloaded: true }, stepper: state.talkAndChooseAndSeek.stepper}
